var faceboook = function(){
	...
	Titanium.Facebook.appid = "468900563142822";
...
function showCommentStuff(){
	...
	send_button.addEventListener('click', function(){
		var description =
			"¿Qué tanto sabes de la historia de Tigres? Con esta aplicación conocerás mejor que nadie y de una manera entretenida la historia de los Tigres." + 
			"\nLos mejores partidos de toda la historia del equipo Tigres." +
			"\nDatos históricos de los jugadores de Tigres que no encontrarás en ninguna otra parte." +
			"\nLas trivias más divertidas y más sorprendentes de Tigres." +
		...
		var data = {
			link: "https://www.facebook.com/tigretrivia",
			name: "Inolvidables jugadores y las grandes hazañas de los Tigres reunidas en esta aplicación",
			message: textarea.getValue(),
			caption: "Tigre Trivia",
			picture: "https://fbcdn-sphotos-d-a.akamaihd.net/hphotos-ak-ash4/420684_193078040798622_1606355122_n.jpg",
